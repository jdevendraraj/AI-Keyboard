...
import serveAudioFilesRouter from "./routes/serveAudioFiles.js";
...
logger.warn("Custom prompts are forwarded to LLM provider and not stored by this server", {
    warning:
        "Custom prompt templates sent by clients are forwarded to the configured LLM API and subject to third-party processing. Do not include secrets in prompts.",
});
...
export function createServer(): express.Application {
    ...
    app.use("/audio-files", serveAudioFilesRouter);
