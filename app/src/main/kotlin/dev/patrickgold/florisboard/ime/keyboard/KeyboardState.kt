...
open class KeyboardState protected constructor(open var rawValue: ULong) {
    companion object {
        ...
        const val F_IS_VOICE_OVERLAY_VISIBLE: ULong =       0x00040000u
    ...
    var isVoiceOverlayVisible: Boolean
        get() = getFlag(F_IS_VOICE_OVERLAY_VISIBLE)
        set(v) { setFlag(F_IS_VOICE_OVERLAY_VISIBLE, v) }
